"""Odometer Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.odometer.pro"
NAME = "Odometer Pro"
PRICE = "4.99"
DESCRIPTION = "More vehicles, costs, service history PDF, CSV."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free; one vehicle with its maintenance schedule, reminders, "
    "fill-ups and economy, service and expense log and glovebox dates is free forever. Pro unlocks more "
    "vehicles, the Costs tab, the service history PDF and CSV export. To see the paywall: add a vehicle, then "
    "tap the Costs tab and tap See Odometer Pro, or tap Service history on the Car tab. Restore purchase is on "
    "the paywall and under SEE on the Odometer Pro card in Settings (gear, top right of the Car tab)."
)
